...
@Component({
  ...
  templateUrl: "./variety-conversion-history.component.html",
  styleUrls: ["../detail/detail.component.scss"],
})
export class VarietyConversionHistoryComponent implements OnInit {
  dataSource = [];
  ...
  canPrint: boolean;
  canUpdate: boolean;
  constructor(private router: Router, private service: VarietyConversionService, private commonService: CommonBaseService) {}
  ...
  gotoStockConversionForm() {
    this.router.navigate(["/production/variety-conversion-form"]);
  }
