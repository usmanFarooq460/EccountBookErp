...
@Component({
  selector: "variety-conversion-trade-pro-detail",
  templateUrl: "./detail.component.html",
  styleUrls: ["./detail.component.scss"],
})
export class VarietyConversionTradeProDetail implements OnInit {
  @Input() key: any;
  @Input() rowData: any;
  inputDataSource = [];
  outputDataSource = [];
  ...
  constructor(private commonService: CommonBaseService, private service: VarietyConversionTradeProService) {}
