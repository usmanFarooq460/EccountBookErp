...
export class PyablesRecievablesAgingService {
  ...
  AccountsGetAll(data) {
    return this.http.post<any>(this.apiUrl + "ChartofAccount/GetByOrganizationCompanyId", data, { headers: this.headers });
  }
  ...
  PayablesandReceivablesMenagment(data) {
    return this.http.post<any>(this.apiUrl + "AccountsReports/PayablesandReceivablesMenagment", data, {
      headers: this.headers,
    });
  }

  AccountsCustomGroupGetAll(data) {
    return this.http.post<any>(this.apiUrl + "AccountsCustomGroupsController/GetAll", data, {
      headers: this.headers,
    });
  }
  AccountsLookupGetAll(data) {
    return this.http.post<any>(this.apiUrl + "AcLookUpsController/GetAll", data, {
      headers: this.headers,
    });
  }
}
